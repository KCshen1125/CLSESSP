    ...
    def _pad(
        ...
        if needs_to_be_padded:
            ...
            if self.padding_side == "right":
                ...
                if "prompt_mask" in encoded_inputs:
                    encoded_inputs["prompt_mask"] = encoded_inputs["prompt_mask"] + [0] * difference
                ...
                if "prompt_mask" in encoded_inputs:
                    encoded_inputs["prompt_mask"] = [0] * difference + encoded_inputs["prompt_mask"] 
