...
# 配置参数
model_name_or_path = "/hy-tmp/promptCSE-main/promptCSE-main/ConPVP/model_path/bert-base-uncased"  # 模型路径
...
wiki_path = "/hy-tmp/promptCSE-main/promptCSE-main/ConPVP/data/wiki1m_for_simcse.txt"  # 更改为您的wiki文件路径
...
# 添加标题和轴标签
plt.title('Probability Distributions of Positive Pairs')
...
# 保存图像
plt.savefig('/hy-tmp/promptCSE-main/promptCSE-main/ConPVP/result/positive_pairs_distribution.png', dpi=300, bbox_inches='tight')
